...
public class Operations
{
    ...
    {
        return (num & ~(0xFF << (which << 3)))| (a_byte << (which << 3));//First Set selected byte to 0, then or it with given byte moved to the byte location
    }
